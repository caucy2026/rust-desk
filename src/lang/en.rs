...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("server_ready_status", "Connected to server; ready to connect"),
        ("server_connecting_status", "Connecting to server…"),
        ("server_offline_status", "Server is offline. Check your network"),
        ("remote_session_settings_blocked", "Remote session in progress. Remote users cannot change local settings"),
        ...
        ("Two-Finger vertically", "Two-finger vertically"),
