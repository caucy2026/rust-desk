...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("server_ready_status", "服务器已连接，可以发起或接收连接"),
        ("server_connecting_status", "正在连接服务器…"),
        ("server_offline_status", "服务器未连接，请检查网络"),
        ("remote_session_settings_blocked", "远程会话进行中，远端不可修改本机设置"),
        ...
        ("Start on boot", "开机自启"),
        ("Launch KEMI when you log in to this Mac", "登录 Mac 后自动启动 KEMI。"),
