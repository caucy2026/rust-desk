...
**KEMI-远程桌面** 是基于 [RustDesk](https://github.com/rustdesk/rustdesk) (AGPL-3.0) 定制的远程桌面客户端，面向 Android PAD 与 macOS 双端协同场景。当前源码、Mac 安装版与 PAD 测试机均为 **1.4.32+90**。Mac 已使用固定本地测试签名。
