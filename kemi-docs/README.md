...
**KEMI-远程桌面** 是基于 [RustDesk](https://github.com/rustdesk/rustdesk) (AGPL-3.0) 定制的远程桌面客户端，面向 Android PAD 与 macOS 双端协同场景。当前桌面端源码版本为 **1.4.22+80**；PAD 已安装验证版本为 **1.4.21+79**。
