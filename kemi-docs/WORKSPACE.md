...
`BIN/`用于保存本地交付包：Android固定签名release当前为`1.4.46+105`，macOS App和
macOS arm64 ZIP为`1.4.46+104`，Windows x64和Linux x86_64客户端为`1.4.46`；
旧PAD debug APK和历史版本只用于回溯。BIN不是Git源码备份；每份制品仍需
