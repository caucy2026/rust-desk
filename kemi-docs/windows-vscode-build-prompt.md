...
> 适用版本：`1.4.46+105`，目标：Windows 10/11 x64。本文给从 GitHub 下载源码的同事使用。最省事的方式是把第 2 节整段复制给 VSCode 中的 Codex/Copilot/其他编程助手，让它先检查环境，再逐步执行并报告。
...
7. 构建前核对版本一致：
   - flutter/pubspec.yaml：例如 1.4.46+105
